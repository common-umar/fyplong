...
# Safely find the index of the default game in the dataset, if provided
if default_game in games_df['Title'].to_list():
    default_index = games_df['Title'].to_list().index(default_game) + 1  # +1 for the empty string
else:
    default_index = 0  # Default to the first option if not found
